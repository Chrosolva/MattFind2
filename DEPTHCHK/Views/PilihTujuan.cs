...
namespace DEPTHCHK.Views
{
   ...
   IEnumerable<DEPTHCHK.Views.PengirimanForm.RegionOption> regions,
   IEnumerable<DEPTHCHK.Views.PengirimanForm.OwnedOption> owners,
   string[] initialCodes = null)
        ...
        private void RefreshGrid()
        {
            ...
            var q = _db.Tujuans.AsNoTracking().AsQueryable();
